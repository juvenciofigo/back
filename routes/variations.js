...
router.post("/variation/:product", auth.require, AdminValidator, upload.array("files"), variationValidation.createVariation, uploadMultiple, VariationController.createVariation);

router.put("/variation/:id", auth.require, AdminValidator, upload.array("files"), variationValidation.updateVariation, uploadMultiple, VariationController.updateVariation);
